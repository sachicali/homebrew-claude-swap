...
readonly ZAI_BASE_URL="${CLAUDE_ZAI_BASE_URL:-$ZAI_BASE_URL_DEFAULT}"
readonly ZAI_AUTH_TOKEN="${CLAUDE_ZAI_AUTH_TOKEN:-}"
readonly ZAI_TIMEOUT="${CLAUDE_ZAI_TIMEOUT:-$ZAI_TIMEOUT_DEFAULT}"

readonly MINIMAX_BASE_URL="${CLAUDE_MINIMAX_BASE_URL:-$MINIMAX_BASE_URL_DEFAULT}"
readonly MINIMAX_AUTH_TOKEN="${CLAUDE_MINIMAX_AUTH_TOKEN:-}"
readonly MINIMAX_TIMEOUT="${CLAUDE_MINIMAX_TIMEOUT:-$MINIMAX_TIMEOUT_DEFAULT}"

readonly KIMI_BASE_URL="${CLAUDE_KIMI_BASE_URL:-$KIMI_BASE_URL_DEFAULT}"
readonly KIMI_AUTH_TOKEN="${CLAUDE_KIMI_AUTH_TOKEN:-}"
readonly KIMI_TIMEOUT="${CLAUDE_KIMI_TIMEOUT:-$KIMI_TIMEOUT_DEFAULT}"

# Kimi for Coding uses same auth token but different base URL
readonly KIMI_FOR_CODING_BASE_URL="${CLAUDE_KIMI_FOR_CODING_BASE_URL:-$KIMI_FOR_CODING_BASE_URL_DEFAULT}"
readonly KIMI_FOR_CODING_AUTH_TOKEN="${CLAUDE_KIMI_AUTH_TOKEN:-}"  # Same token as regular Kimi
readonly KIMI_FOR_CODING_TIMEOUT="${CLAUDE_KIMI_FOR_CODING_TIMEOUT:-$KIMI_FOR_CODING_TIMEOUT_DEFAULT}"

readonly STANDARD_TIMEOUT="${CLAUDE_STANDARD_TIMEOUT:-$STANDARD_TIMEOUT_DEFAULT}"
